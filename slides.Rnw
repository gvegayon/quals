...
\item $\sim$ 44,700 validated terms  \hyperlink{aphylo-goexample}{\beamergotobutton{more}}, $\sim$ 7,300,000 annotations on $\sim$ 4,500 species.
...
\item A single family can host multiple species (like the lizard and the fish)
\end{itemize}
\end{minipage}
\hfill
