...
<<random-tree, echo=FALSE, messages=FALSE, out.width=".6\\linewidth", fig.align='center'>>=
...
\hyperlink{aphylographicalviewcont}{\beamergotobutton{go back}}
...
\hyperlink{aphylographicalviewcont}{\beamerreturnbutton{go back}}
