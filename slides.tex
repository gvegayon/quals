\documentclass[aspectratio=169, 9pt, draft]{beamer}\usepackage[]{graphicx}\usepackage[]{color}
...
\item Paper 1: Phylogenetic models of gene functional evolution
  \begin{itemize}
  \item A parsimonious, computational scalable model.
  \item Performance comparable to state-of-the-art models.
  \item \textbf{Next steps:} Breaking assumptions and use what I've learned from ERGMs.
  \end{itemize}
...
\vfill
\footnotesize 
\uncover<9->{{\bf Accomplishments during the development of this work}}
\uncover<9->{
\begin{beamercolorbox}{conclusions}
\begin{itemize}
\item<10->6 journal publications (Journal of Open Source Software, Stata Journal, Journal of health and social behavior, Translational behavioral medicine, Social Science \& Medicine)
\item<11->11 packages/libraries built (ergmito, similR, gnet, fmcmc, slurmR, aphylo, polygons, pruner, netplot, rphyloxml, jsPhyloSVG)
\end{itemize}
\end{beamercolorbox}
}
\end{frame}
